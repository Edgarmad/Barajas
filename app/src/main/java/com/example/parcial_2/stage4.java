...
public class stage4 extends Activity {
    //cambiar esto
    public ImageButton el0, el1, el2, el3, el4, el5, el6, el7, el8, el9, el10, el11;
    public Button reiniciar, salir;
    public int imagenes[];
    //cambiar esto
    public ImageButton [] botonera = new ImageButton[12];
    public int fondo;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //cambiar esto
        setContentView(R.layout.layout_stage4);
    ...
    public void cargarBotones(){
        ...
        botonera[7] = el7;
        el4 = (ImageButton) findViewById(R.id.boton08);
        botonera[8] = el8;
        el5 = (ImageButton) findViewById(R.id.boton09);
        botonera[9] = el9;
        el6 = (ImageButton) findViewById(R.id.boton10);
        botonera[10] = el10;
        el7 = (ImageButton) findViewById(R.id.boton11);
        botonera[11] = el11;
